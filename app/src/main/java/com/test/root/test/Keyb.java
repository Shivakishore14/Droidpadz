...
public class Keyb extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tracker.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                fun(String.valueOf(sx) + "x" + String.valueOf(sy));
                tracker.setText("Touch coordinates : " + String.valueOf(x / 2 - event.getX()) + "x" + String.valueOf(y / 2 - event.getY()));
